<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="login_faculty.aspx.cs" Inherits="login_login_faculty" %>
        ...
        <div class="jumbotron">
            <div class="wrapper">
                <form class="form-signin" runat="server">
                    <h3 class="text-center" style="font-family: 'Righteous', cursive; color: #00cc00;">Faculty Login</h3>
                    E-mail:
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="E-mail required!" SetFocusOnError="True" ControlToValidate="TextBox1" ForeColor="Red"></asp:RequiredFieldValidator>
                    <br />
                    Password:
                    <asp:TextBox ID="TextBox2" runat="server" class="form-control" name="password" placeholder="Password" TextMode="Password" MaxLength="10"></asp:TextBox>
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="btn btn-block btn-success btn-lg form-control" OnClick="Button1_Click" />
