<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="reg_student.aspx.cs" Inherits="registration_reg_student" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainBody" runat="Server">
    <div class="container">
        <div class="jumbotron registration">
            <h2 class="text-center" style="font-family: 'Righteous', cursive; color: #4da6ff;">Student Registration</h2>
            <form class="form-signin" runat="server">
                Enrollment No.:<asp:TextBox ID="TextBox6" runat="server" class="form-control" name="fullname" placeholder="Enrollment Number" MaxLength="10"></asp:TextBox>

                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enrollment no. required!" ControlToValidate="TextBox6" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Name required!" ControlToValidate="TextBox1" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="E-mail required!" ControlToValidate="TextBox2" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
                Mobile No.:<asp:TextBox ID="TextBox3" runat="server" class="form-control" name="fullname" placeholder="Mobile Number" TextMode="SingleLine" MaxLength="10"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Mobile no. required!" ControlToValidate="TextBox3" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Branch required!" ControlToValidate="DropDownList1" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>

                <br />
                Class:<asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="Class required!" ControlToValidate="DropDownList2" SetFocusOnError="True" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                <br />
                <br />
                I am intrested to become a Coordinator
                <asp:CheckBox ID="CheckBox1" runat="server" CssClass="checkbox" />
                <asp:Button ID="Button1" runat="server" Text="Submit Details" CssClass="btn btn-block btn-primary btn-lg form-control" OnClick="Button1_Click" />
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title text-primary mr-auto">Enter Correct Enrollment Number!</h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-footer">
